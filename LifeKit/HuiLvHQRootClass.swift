...
class HuiLvHQRootClass{

	var showapiResBody : HuiLvHQShowapiResBody!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let showapiResBodyData = dictionary["showapi_res_body"] as? NSDictionary{
			showapiResBody = HuiLvHQShowapiResBody(fromDictionary: showapiResBodyData)
		}
