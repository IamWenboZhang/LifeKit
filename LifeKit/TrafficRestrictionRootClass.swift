...
class TrafficRestrictionRootClass{

	var showapiResBody : TrafficRestrictionShowapiResBody!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let showapiResBodyData = dictionary["showapi_res_body"] as? NSDictionary{
			showapiResBody = TrafficRestrictionShowapiResBody(fromDictionary: showapiResBodyData)
		}
