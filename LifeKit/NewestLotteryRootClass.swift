...
class NewestLotteryRootClass{

	var showapiResBody : NewestLotteryShowapiResBody!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let showapiResBodyData = dictionary["showapi_res_body"] as? NSDictionary{
			showapiResBody = NewestLotteryShowapiResBody(fromDictionary: showapiResBodyData)
		}
