...
class MutileLotteryRootClass{

	var showapiResBody : MutileLotteryShowapiResBody!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let showapiResBodyData = dictionary["showapi_res_body"] as? NSDictionary{
			showapiResBody = MutileLotteryShowapiResBody(fromDictionary: showapiResBodyData)
		}
