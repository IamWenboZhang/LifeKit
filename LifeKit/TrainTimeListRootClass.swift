...
class TrainTimeListRootClass{

	var showapiResBody : TrainTimeListShowapiResBody!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let showapiResBodyData = dictionary["showapi_res_body"] as? NSDictionary{
			showapiResBody = TrainTimeListShowapiResBody(fromDictionary: showapiResBodyData)
		}
