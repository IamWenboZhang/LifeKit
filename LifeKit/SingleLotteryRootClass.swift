...
class SingleLotteryRootClass{

	var showapiResBody : SingleLotteryShowapiResBody!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let showapiResBodyData = dictionary["showapi_res_body"] as? NSDictionary{
			showapiResBody = SingleLotteryShowapiResBody(fromDictionary: showapiResBodyData)
		}
